  ...
  return (
    <div className="h-dvh bg-black text-gray-100 flex flex-col items-center p-4 overflow-y-auto">
      ...
      <footer className="w-full shrink-0 p-4 text-center text-gray-500 text-xs">
        Built with Gemini 2.5 Flash Image Preview | Created by <a href="http://x.com/pitaru" target="_blank" rel="noopener noreferrer" className="underline hover:text-indigo-400">@pitaru</a> and Ahmed Jaballah
      </footer>
    </div>
  );
};
